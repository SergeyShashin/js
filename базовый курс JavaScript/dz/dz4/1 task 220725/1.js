...
console.log(transferNumberToObject(Number(prompt('Напечайтайте, пожалуйста, числов в диапазоне [0,999]'))));

function transferNumberToObject(number) {
  if (number > -1 && number < 1000) {
    ...
    console.log('Ожидается число в диапазоне [0,999]');
    return {}
  }
