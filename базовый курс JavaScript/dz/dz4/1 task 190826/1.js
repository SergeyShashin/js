...
console.log(numberTransformObjectWithDigit(parseInt(prompt('Напечатайте, пожалуйста, число в диапазоне [0,  999].'))));

function numberTransformObjectWithDigit(number) {
  if (number < 0 || number > 999||!Number.isInteger(number)) {
    console.log(`[${number}] вне диапазона [0, 999], не целое число или вообще не число.`);
    return {}
  }
  return {
