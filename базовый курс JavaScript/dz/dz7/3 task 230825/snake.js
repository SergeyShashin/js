...
const snake = {
  ...
  getNextHeadPoint(borderX, borderY) {
    let headPoint = Object.assign({}, this.body[0]);
    switch (this.direction) {
      case 'down':
        headPoint.y + 1 === borderY ? headPoint.y = 0 : headPoint.y++;
        break;
      case 'up':
        headPoint.y - 1 === -1 ? headPoint.y = borderY - 1 : headPoint.y--;
        break;
      case 'left':
        headPoint.x - 1 === -1 ? headPoint.x = borderX - 1 : headPoint.x--;
        break;
      case 'right':
        headPoint.x + 1 === borderX ? headPoint.x = 0 : headPoint.x++;
        break;
    }
    return headPoint;
  },
