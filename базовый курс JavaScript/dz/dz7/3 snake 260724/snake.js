...
const counter = {
  count: null,
  HTMLELementCounter: null,

  init(startCount) {
    this.count = startCount;
    this.HTMLELementCounter = document.getElementById('counter');
    this.HTMLELementCounter.textContent = this.count;
  },
...
const game = {
  ...
  tickInterval() {
    ...
    if (nextHeadPoint.y === -1) {
      nextHeadPoint.y = rowsCount - 1;
    }

    if (nextHeadPoint.y === rowsCount) {
      nextHeadPoint.y = 0;
    }
